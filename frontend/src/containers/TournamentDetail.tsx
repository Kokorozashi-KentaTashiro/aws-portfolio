...
const TournamentDetail = () => {
    ...
    const tournamentDetailInfo: TornamentDetailInfo = useSelector(selectTournamentDetailInfo);
      ...
      <Layout>
        <CommonContainer>
          ...
          {tournamentDetailInfo.reception && (
            <CommonButton variant="contained" onClick={onClickApply}>応募</CommonButton>
          )}
        </CommonContainer>
      </Layout>
    </>
