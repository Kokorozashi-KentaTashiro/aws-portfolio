...
export const putSinglesApplications = async (body: any) => {
  ...
  const { tournamentTitle, teamInfo, directerInfo, singlesApplicationsInfo } =
    body;
    ...
    .put(
      {
        ...
        Item: {
          // 検索情報
          partitionKey: `${teamInfo.team}${teamInfo.teamSex}${todayStr}`,
      ...
      .put(
        {
          ...
          Item: {
            ...
            sortKey: `${teamInfo.team}${teamInfo.teamSex}${todayStr}`,
            // 参加者情報
